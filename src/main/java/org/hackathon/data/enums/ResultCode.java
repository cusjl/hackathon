...
public enum ResultCode {
    ...
    TEAM_TRACK_CONFLICT(3118, HttpStatus.CONFLICT, "报名赛道与队伍赛道不一致"),
    INVITE_CODE_INVALID(3119, HttpStatus.NOT_FOUND, "队伍邀请码无效"),
    //312X   招募、申请与邀请
    RECRUITMENT_NOT_FOUND(3121, HttpStatus.NOT_FOUND, "招募信息不存在"),
    RECRUITMENT_CLOSED(3122, HttpStatus.CONFLICT, "招募已关闭"),
    RECRUITMENT_CAPACITY_CONFLICT(3123, HttpStatus.CONFLICT, "招募人数超过队伍剩余名额"),
    APPLICATION_NOT_FOUND(3124, HttpStatus.NOT_FOUND, "入队申请不存在"),
    APPLICATION_ALREADY_HANDLED(3125, HttpStatus.CONFLICT, "入队申请已处理"),
    INVITATION_NOT_FOUND(3126, HttpStatus.NOT_FOUND, "组队邀请不存在"),
    INVITATION_ALREADY_HANDLED(3127, HttpStatus.CONFLICT, "组队邀请已处理"),
    RECOMMENDATION_NOT_FOUND(3128, HttpStatus.NOT_FOUND, "自荐信息不存在"),
    INVALID_TEAM_CAPACITY(3129, HttpStatus.BAD_REQUEST, "队伍人数上下限配置非法"),
    TEAM_TOO_SMALL(3130, HttpStatus.CONFLICT, "队伍人数未达到赛事最低要求"),
    LEADER_UNCHANGED(3131, HttpStatus.CONFLICT, "该成员已经是队长"),
    //32XX  时间窗
